...
import Details5 from "@/presentation/components/product-detail/Details5";
...
export const metadata = {
  title: "Product Details 03 || shipazo - Multipurpose React Nextjs eCommerce",
      ...
      <div className="tf-sp-1">
        <div className="container">
          <ul className="breakcrumbs">
            ...
            <li>
              <span className="body-small">Product Detail 3</span>
            </li>
          </ul>
        </div>
      </div>
