"use client";
import { products13 } from "@/shared/constants/products";
      ...
      <div className="container">
        <div className="flat-title wow fadeInUp" data-wow-delay="0s">
          ...
          <div className="box-btn-slide relative">
            <div className="swiper-button-prev nav-swiper nav-prev-products snbp37">
              <i className="icon-arrow-left-lg" />
            </div>
            <div className="swiper-button-next nav-swiper nav-next-products snbn37">
        ...
        >
          ...
          <div className="d-flex d-xl-none sw-dot-default sw-pagination-products justify-content-center spd37" />
        </Swiper>
      </div>
    </section>
  );
